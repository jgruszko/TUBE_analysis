{
  ...
  const char* templatename = "fitAllPeaks_noTails";
  const char* outputfile = "fitResults_calibDS4.root";
  ...
  cout << "Calibration parameters: " << cal0 << ' ' << cal1 << endl;
	...
	calMap.AddEntryToVectors(112, histname, 2574, 2575);
	calMap.SetScale(112, histname,  2574, 2575, cal1);
	calMap.SetOffset(112, histname, 2574, 2575, cal0);
